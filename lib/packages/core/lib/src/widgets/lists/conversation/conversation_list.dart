    ...
    return LMChatBubble(
      onReplyTap: () async {
        ...
        if (index != -1) {
          ...
          replyConversation = replyConverVD.first;
          ...
          // allConversations.addAll(replyConverVD);
          allConversations.addAll(bottomConverVD.reversed);
          allConversations.addAll(topConverVD);
